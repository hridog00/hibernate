...
public class Nomina implements java.io.Serializable {
	...
	double tDeducciones;
	@Transient
	double costeTotalTrabajador;
	@Transient
	double valorParaIrpf;
	...
	public double gettDeducciones() {
		return tDeducciones;
	}

	public void settDeducciones(double tDeducciones) {
	...
	public double getValorParaIrpf() {
		return valorParaIrpf;
	}

	public void setValorParaIrpf(double valorParaIrpf) {
		this.valorParaIrpf = valorParaIrpf;
	}
